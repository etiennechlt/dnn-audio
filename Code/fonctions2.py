...
#on ajoute le spectro au dossier
    ...
    np.save('../Data/Spec_TEST/Noisy/Modulus/' + br_name, spec_br.astype(np.float32))
    np.save('../Data/Spec_TEST/Noisy/Phase/' + br_phase_name, phase_br.astype(np.float32))

    np.save('../Data/Spec_TEST/Clear/Modulus/' + clear_name, spec_clear.astype(np.float32))
    np.save('../Data/Spec_TEST/Clear/Phase/' + clear_phase_name, phase_clear.astype(np.float32))
